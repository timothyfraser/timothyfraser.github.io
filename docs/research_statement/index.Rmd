...
- Ezra Systems Research Associate, Systems Engineering, Cornell University
...
Since 2017, I published **44 peer-reviewed studies** on adaptation to crisis in US and Japanese cities in top journals on environmental policy and crisis resilience. These include Global Environmental Change (Impact Factor = 9.5), Environmental Innovations and Societal Transitions (9.7), Energy Research & Social Science (6.8), and Nature: Scientific Reports (4.3), plus disciplinary journals such as Environmental Politics (6.7), among others. My dissertation synthesized this work, measuring the effects of social capital in cities’ adaptation to climate change via evacuation, disaster recovery, and energy transitions in the US and Japan. I received my PhD in Political Science from Northeastern University in April 2022. 

In addition, I have collaborated with **+18 scholars** and **+34 students** studying energy, disasters, environment, urban planning, and health policies. I also published 7 chapters, reviewed for **+30 journals**, and worked as a data consultant for 3 NGOs, including the United Nations Development Programme’s Accelerator Labs in Mexico and Paraguay. My past research has been funded by **local and national grants**, including a 2016 Fulbright fellowship. I also received 2020 Fulbright Hays and Japan Foundation doctoral fellowships (declined due to COVID-19). I also currently coordinate the **Center for Transportation, Environment, and Community Health (CTECH)**, a multi-million dollar US DOT grant-funded center involving dozens of researchers across 4 universities.
...
METHODOLOGY RESEARCH (1): NETWORKS, MAPPING, & MEASUREMENT {data-icon=circle-nodes}
--------------------------------------------------------------------------------

First, I have built a diverse methodological toolkit to test how structure and representation in social and political networks shape urban policy outcomes, and vice versa. I focus on (1) network statistics, (2) GIS, and (3) quasi-experiments. I apply these tools to test impacts of social and political networks on environmental policy outcomes; some non-exhaustive examples include emissions ([Fraser & Temocin 2022](https://github.com/timothyfraser/cv/files/7790564/2021_Fraser_Temocin_CC.pdf]), hurricane evacuation (), disaster recovery ([Fraser, Aldrich, & Small 2021](https://github.com/timothyfraser/cv/files/7790566/2021_Fraser_Aldrich_Small_GEC.pdf)), pandemic outcomes [Fraser et al. 2021](https://github.com/timothyfraser/cv/files/7790571/2021_Fraser_Aldrich_PageTan_SSM.pdf), and mobility (Fraser, Yabe, Aldrich, & Moro 2024), using cell phone user mobility data and network data). I have also conducted nationwide and regional surveys on politics and health ([Panagopoulos et al. 2021](https://drive.google.com/file/d/1ILHI4Fea7Yd5M37kSEFFoytToXh-fHBd/view?usp=sharing); [Dolman et al. 2022](https://drive.google.com/file/d/1Is9yHbIty5M5LZ3wkoGmybe0IZ8IggOB/view?usp=sharing); [Fraser et al. 2022](https://drive.google.com/file/d/1IsTJQvtQ82IapHWtEoWmn3H7ORWsIbLe/view?usp=sharing); [Nayak et al. 2021](https://drive.google.com/file/d/1VI1uP7nLkqwHqRxsG04hlraZkLvxcccD/view?usp=sharing); [Nayak et al. 2024](https://doi.org/10.1016/j.ssmph.2024.101662); Page-Tan, Bourdeau, & Fraser 2024), of Japanese municipal officials ([Fraser 2020](https://drive.google.com/file/d/1jK9L3qLC-Dyz56Sm3zG-KtbyyY3F6GFD/view?usp=sharing)), as well as fieldwork, interviews ([Fraser & Chapman 2018](https://drive.google.com/file/d/1nM_mA0JC7kkSrHjXVfatB5YOxiO2h7DL/view?usp=sharing), [Fraser 2019](https://drive.google.com/file/d/1N00DzoWXfzlSg5QSj7wTnyp0RhOqpBvd/view?usp=sharing) ), and qualitative comparative analysis ([Fraser & Aldrich 2017](https://drive.google.com/file/d/1A9gbamFNyt8QSCMpU5EVGJfXBh6sn6lz/view?usp=sharing), [Fraser, Morikawa, & Aldrich 2021](https://drive.google.com/file/d/1aYZtZv_uQjGs8gZSWSdnbtAD7O4QxTr7/view?usp=sharing)). See below for further details.

### NETWORKS {data-icon=project-diagram}
--------------------------------------------------------------------------------
...
- **Networks of Solar Cities and Companies:** My dissertation research mapped a preliminary network of solar companies operating in Japanese cities, finding that cities with strong social capital and aggressive spending practices on disaster priorities tended to adopt more renewables, and these spending priorities increase with every year (Fraser working paper). In the future, I aim to expand this, measuring the effectiveness of residents’ social networks compared to traits of companies and city spending on adoption.
...
### MAPPING SOCIAL INFRASTRUCTURE {data-icon=map-marked}
--------------------------------------------------------------------------------

In addition, my recent GIS work focuses on a key element of social systems known as **social infrastructure**. Social infrastructure refers to places in our communities that build social capital, including community spaces, places of worship, social businesses, and parks - places that help our cities rebound and recover after crises like the ongoing pandemic. This includes 2 projects:

- **Mapping Social Infrastructure:**  Together with Daniel Aldrich and Courtney Page-Tan at the Aldrich Resilience Lab at Northeastern University, we brainstormed ways to measure social infrastructure in our neighborhoods. 
  - I ran a pilot study, mapping 8 types of social infrastructure in Fukuoka, Japan using publicly available geospatial and census micro-data, and linked rates of social infrastructure to changing COVID-19 spread rates in the city (Fraser working paper). 
  - Then, we ran a pilot study in Boston, using the Google Maps Places API to map social infrastructure for every block in the city of Boston ([Fraser et al. 2022](https://doi.org/10.1016/j.uclim.2022.101287)). I led a master’s capstone at Northeastern in Fall 2021, teaching students to ground-truth these measures street-by-street to verify that our web-generated measures were valid (good news: they are!), and our dashboard. 
  - We found troubling divides in levels of social infrastructure between neighborhoods of color and other neighborhoods ([Fraser et al. 2024](https://drive.google.com/file/d/1QMymsV5h53lD3bms9qohWpNALiJDvG7e/view?usp=sharing)). 
  - Together with undergraduate research students at Cornell, I have completed social infrastructure estimates for the largest 25 cities in the US. 
...
I am eager to continue this work in Ithaca, engaging my students in the effort! I aim to deploy a publicly available database and dashboard, and then to examine how social infrastructure correlates with key disaster and pandemic resilience indicators. Mapping social ties and social infrastructure helps us understand which neighborhoods can organize to combat climate change, and which struggle without support from policymakers.


### MEASUREMENT {data-icon=project-diagram}
--------------------------------------------------------------------------------

Further, focused on building measurements of resources like social ties and social infrastructure using GIS, networks, and big data, and designed methods for analyzing their impacts on community resilience.
...
METHODOLOGY RESEARCH (2): DASHBOARDS, CLOUD COMPUTING, & AI FOR TACKLING POLICY CHALLENGES {data-icon=circle-nodes}
--------------------------------------------------------------------------------

Second, my methodological research also focuses on validating new computational methods to solve policy challenges. Recent examples include API-powered methods to measure social infrastructure, statistical learning for county-specific models of environmental policy outcomes, and dashboards for facilitating policy change: At Cornell, I lead software development for the Climate Action in Transportation team with Dr. Oliver Gao, building dashboards, databases, APIs, and cloud computing jobs to help local decision-makers estimate emissions from transportation online. My ongoing research focuses on building and validating AI policy applications and optimization tools, including (1) AI-powered automated reporting for policymakers, (2) AI models for estimating local level emissions, and (3) optimization tools to simplify policy scenario selection responsibly.
